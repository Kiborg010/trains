...
func toScenarioMetricsDTO(item normalized.ScenarioMetrics) ScenarioMetricsDTO {
	return ScenarioMetricsDTO{
		...
		TotalLocoDistanceMeters:  item.TotalLocoDistanceMeters,
		EmptyLocoDistance:        item.EmptyLocoDistance,
		EmptyLocoDistanceMeters:  item.EmptyLocoDistanceMeters,
		LoadedLocoDistance:       item.LoadedLocoDistance,
		LoadedLocoDistanceMeters: item.LoadedLocoDistanceMeters,
		TotalCouples:             item.TotalCouples,
		TotalDecouples:           item.TotalDecouples,
		TotalSwitchCrossings:     item.TotalSwitchCrossings,
		TotalWagonsMoved:         item.TotalWagonsMoved,
		TotalWagonDistance:       item.TotalWagonDistance,
		TotalWagonDistanceMeters: item.TotalWagonDistanceMeters,
	}
}
